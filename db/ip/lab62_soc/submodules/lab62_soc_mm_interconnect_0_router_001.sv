...
(
    ...
    // -------------------------------------------------------
    localparam PAD0 = log2ceil(64'h120 - 64'h110); 
    localparam PAD1 = log2ceil(64'h138 - 64'h130); 
    ...
    // ( 0x110 .. 0x120 )
    if ( {address[RG:PAD0],{PAD0{1'b0}}} == 28'h110   ) begin
            src_channel = 17'b0100;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 9;
    end

    // ( 0x130 .. 0x138 )
    if ( {address[RG:PAD1],{PAD1{1'b0}}} == 28'h130  && read_transaction  ) begin
