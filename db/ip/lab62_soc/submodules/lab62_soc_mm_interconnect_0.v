...
module lab62_soc_mm_interconnect_0 (
	...
	wire          cmd_mux_006_src_valid;                                                              // cmd_mux_006:src_valid -> key_0_s1_agent:cp_valid
	wire  [107:0] cmd_mux_006_src_data;                                                               // cmd_mux_006:src_data -> key_0_s1_agent:cp_data
	wire          cmd_mux_006_src_ready;                                                              // key_0_s1_agent:cp_ready -> cmd_mux_006:src_ready
	wire   [16:0] cmd_mux_006_src_channel;                                                            // cmd_mux_006:src_channel -> key_0_s1_agent:cp_channel
	wire          cmd_mux_006_src_startofpacket;                                                      // cmd_mux_006:src_startofpacket -> key_0_s1_agent:cp_startofpacket
	wire          cmd_mux_006_src_endofpacket;                                                        // cmd_mux_006:src_endofpacket -> key_0_s1_agent:cp_endofpacket
	...
	wire   [27:0] key_1_s1_agent_m0_address;                                                          // key_1_s1_agent:m0_address -> key_1_s1_translator:uav_address
	...
	wire  [108:0] key_1_s1_agent_rf_source_data;                                                      // key_1_s1_agent:rf_source_data -> key_1_s1_agent_rsp_fifo:in_data
	...
	wire  [108:0] key_1_s1_agent_rsp_fifo_out_data;                                                   // key_1_s1_agent_rsp_fifo:out_data -> key_1_s1_agent:rf_sink_data
	...
	wire          cmd_mux_007_src_valid;                                                              // cmd_mux_007:src_valid -> key_1_s1_agent:cp_valid
	wire  [107:0] cmd_mux_007_src_data;                                                               // cmd_mux_007:src_data -> key_1_s1_agent:cp_data
	wire          cmd_mux_007_src_ready;                                                              // key_1_s1_agent:cp_ready -> cmd_mux_007:src_ready
	wire   [16:0] cmd_mux_007_src_channel;                                                            // cmd_mux_007:src_channel -> key_1_s1_agent:cp_channel
	wire          cmd_mux_007_src_startofpacket;                                                      // cmd_mux_007:src_startofpacket -> key_1_s1_agent:cp_startofpacket
	wire          cmd_mux_007_src_endofpacket;                                                        // cmd_mux_007:src_endofpacket -> key_1_s1_agent:cp_endofpacket
	...
	wire   [16:0] cmd_mux_009_src_channel;                                                            // cmd_mux_009:src_channel -> usb_gpx_s1_agent:cp_channel
	...
	wire  [107:0] cmd_mux_010_src_data;                                                               // cmd_mux_010:src_data -> usb_irq_s1_agent:cp_data
	wire          cmd_mux_010_src_ready;                                                              // usb_irq_s1_agent:cp_ready -> cmd_mux_010:src_ready
	wire   [16:0] cmd_mux_010_src_channel;                                                            // cmd_mux_010:src_channel -> usb_irq_s1_agent:cp_channel
	...
	wire  [107:0] cmd_mux_013_src_data;                                                               // cmd_mux_013:src_data -> led_pio_s1_agent:cp_data
	wire          cmd_mux_013_src_ready;                                                              // led_pio_s1_agent:cp_ready -> cmd_mux_013:src_ready
	wire   [16:0] cmd_mux_013_src_channel;                                                            // cmd_mux_013:src_channel -> led_pio_s1_agent:cp_channel
	...
	wire          key_0_s1_agent_rp_valid;                                                            // key_0_s1_agent:rp_valid -> router_008:sink_valid
	wire  [107:0] key_0_s1_agent_rp_data;                                                             // key_0_s1_agent:rp_data -> router_008:sink_data
	wire          key_0_s1_agent_rp_ready;                                                            // router_008:sink_ready -> key_0_s1_agent:rp_ready
	wire          key_0_s1_agent_rp_startofpacket;                                                    // key_0_s1_agent:rp_startofpacket -> router_008:sink_startofpacket
	wire          key_0_s1_agent_rp_endofpacket;                                                      // key_0_s1_agent:rp_endofpacket -> router_008:sink_endofpacket
	...
	wire          key_1_s1_agent_rp_valid;                                                            // key_1_s1_agent:rp_valid -> router_009:sink_valid
	wire  [107:0] key_1_s1_agent_rp_data;                                                             // key_1_s1_agent:rp_data -> router_009:sink_data
	wire          key_1_s1_agent_rp_ready;                                                            // router_009:sink_ready -> key_1_s1_agent:rp_ready
	wire          key_1_s1_agent_rp_startofpacket;                                                    // key_1_s1_agent:rp_startofpacket -> router_009:sink_startofpacket
	wire          key_1_s1_agent_rp_endofpacket;                                                      // key_1_s1_agent:rp_endofpacket -> router_009:sink_endofpacket
	...
	wire  [107:0] usb_irq_s1_agent_rp_data;                                                           // usb_irq_s1_agent:rp_data -> router_012:sink_data
	...
	wire  [107:0] led_pio_s1_agent_rp_data;                                                           // led_pio_s1_agent:rp_data -> router_015:sink_data
	...
	wire   [16:0] cmd_demux_001_src3_channel;                                                         // cmd_demux_001:src3_channel -> crosser_001:in_channel
	...
	wire   [16:0] crosser_003_out_channel;                                                            // crosser_003:out_channel -> rsp_mux_001:sink3_channel
	...
	wire          key_0_s1_agent_rdata_fifo_src_valid;                                                // key_0_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_006:in_0_valid
	wire   [33:0] key_0_s1_agent_rdata_fifo_src_data;                                                 // key_0_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_006:in_0_data
	wire          key_0_s1_agent_rdata_fifo_src_ready;                                                // avalon_st_adapter_006:in_0_ready -> key_0_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_006_out_0_valid;                                                  // avalon_st_adapter_006:out_0_valid -> key_0_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_006_out_0_data;                                                   // avalon_st_adapter_006:out_0_data -> key_0_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_006_out_0_ready;                                                  // key_0_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_006:out_0_ready
	wire    [0:0] avalon_st_adapter_006_out_0_error;                                                  // avalon_st_adapter_006:out_0_error -> key_0_s1_agent:rdata_fifo_sink_error
	wire          key_1_s1_agent_rdata_fifo_src_valid;                                                // key_1_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_007:in_0_valid
	wire   [33:0] key_1_s1_agent_rdata_fifo_src_data;                                                 // key_1_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_007:in_0_data
	wire          key_1_s1_agent_rdata_fifo_src_ready;                                                // avalon_st_adapter_007:in_0_ready -> key_1_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_007_out_0_valid;                                                  // avalon_st_adapter_007:out_0_valid -> key_1_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_007_out_0_data;                                                   // avalon_st_adapter_007:out_0_data -> key_1_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_007_out_0_ready;                                                  // key_1_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_007:out_0_ready
	wire    [0:0] avalon_st_adapter_007_out_0_error;                                                  // avalon_st_adapter_007:out_0_error -> key_1_s1_agent:rdata_fifo_sink_error
	...
	lab62_soc_mm_interconnect_0_router_003 router_004 (
	...
	lab62_soc_mm_interconnect_0_router_003 router_005 (
	...
	lab62_soc_mm_interconnect_0_cmd_mux_001 cmd_mux_001 (
		.clk                 (clk_0_clk_clk),                                 //       clk.clk
		.reset               (jtag_uart_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab62_soc_mm_interconnect_0_cmd_mux_001 cmd_mux_002 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab62_soc_mm_interconnect_0_cmd_mux_001 cmd_mux_003 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab62_soc_mm_interconnect_0_cmd_mux_001 cmd_mux_005 (
		.clk                 (sdram_pll_c0_clk),                        //       clk.clk
		.reset               (sdram_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab62_soc_mm_interconnect_0_rsp_demux_001 rsp_demux_002 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab62_soc_mm_interconnect_0_rsp_demux_001 rsp_demux_003 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab62_soc_mm_interconnect_0_rsp_demux_001 rsp_demux_005 (
		.clk                (sdram_pll_c0_clk),                             //       clk.clk
		.reset              (sdram_reset_reset_bridge_in_reset_reset),      // clk_reset.reset
