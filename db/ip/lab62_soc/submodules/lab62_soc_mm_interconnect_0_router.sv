...
(
    ...
    localparam PAD13 = log2ceil(64'h130 - 64'h128); 
    localparam PAD14 = log2ceil(64'h138 - 64'h130); 
    ...
    // ( 0x128 .. 0x130 )
    if ( {address[RG:PAD13],{PAD13{1'b0}}} == 28'h128   ) begin
            src_channel = 17'b00000000000000001;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 1;
    end

    // ( 0x130 .. 0x138 )
    if ( {address[RG:PAD14],{PAD14{1'b0}}} == 28'h130  && read_transaction  ) begin
