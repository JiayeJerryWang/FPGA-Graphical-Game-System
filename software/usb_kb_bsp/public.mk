...
# setting SOPC_SYSID_BASE_ADDRESS is 0x80011f0
SOPC_SYSID_FLAG += --sidp=0x80011f0
ELF_PATCH_FLAG  += --sidp 0x80011f0

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1650491057
SOPC_SYSID_FLAG += --timestamp=1650491057
ELF_PATCH_FLAG  += --timestamp 1650491057
